...
--указан уровень человека в организации (OrganizationLevel) или
--нет, из таблиц Person.Person, HumanResources.Employee,
--используя LEFT OUTER JOIN.
SELECT p."FirstName", p."LastName", e."OrganizationLevel"
